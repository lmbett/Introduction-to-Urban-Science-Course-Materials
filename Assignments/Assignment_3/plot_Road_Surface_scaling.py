...
xx=np.log10(poproads)
yy=np.log10(roads)

plt.plot(xx,yy,color='blue',marker='o',ms=10,ls='None',alpha=0.3)
...
plt.ylabel('US Metropolitan Road Surface')
#str='scaling_Road_Surface.png'
#savefig(str)
        #,dpi=400)
plt.show()
